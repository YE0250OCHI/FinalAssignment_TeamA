...
async function updateTaskList() {
    try {
        ...
        const response = await fetch('/api/v1/picking-orders');
        ...
        const container =
            document.getElementById('incompleteTaskListContainer');
        ...
        tasks.forEach(function (item) {
            ...
            html +=
                ...
                '<form method="post" action="/picking-orders/' +
                encodeURIComponent(item.jobId) +
                '?handler=Cancel">' +
